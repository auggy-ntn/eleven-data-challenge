...
def silver_to_gold():
    ...
    logger.info(f"Reading training airport data from {SILVER_TRAINING_AIRPORT_DATA_PATH}")
    ...
    training_airport_data = add_distance_columns(training_airport_data, runway_stand_distances)
